...
2. Measure numbers in the mode analysis and digital music files are counted through the first and second endings in the music. For instance, if the first ending is measure 8, the second ending is counted here as measure 9. 
3. The digital files do not use modal key signatures because of Humdrum limitations. Tunes in G freygish, for instance, use a three-flat key signature with B-natural accidentals.
